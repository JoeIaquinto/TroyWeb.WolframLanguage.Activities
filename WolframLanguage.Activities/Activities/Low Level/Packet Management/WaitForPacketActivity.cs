...
{
    [LocalizedDisplayName(nameof(Resources.WaitForPacketActivityDisplayName))]
    [LocalizedDescription(nameof(Resources.WaitForPacketActivityDescription))]
    public class WaitForPacketActivity : NativeActivity
    {
